...
# functions
mcmc.log.lik <- function(xi.arg, omega.arg, psi.arg, gamma.arg, A.arg, B.arg, a.arg, b.arg) {
  return(sum(dnorm(Y, f(xi.arg, A.arg = A.arg, B.arg = B.arg, a.arg = a.arg, b.arg = b.arg), omega.arg, log = TRUE)) +
...
mcmc.alg <- function(n.rep, mcmc.arg = NULL, omega.arg = omega, psi.arg = psi, gamma.arg = gamma,
  ...
  for (j in 1:n.rep) {
    ...
    for (i in 1:n) {
      ...
      log.prob <- min(1, mcmc.log.lik(xi.p, omega.arg, psi.arg, gamma.arg, A.arg, B.arg, a.arg, b.arg) -
        mcmc.log.lik(mcmc.arg$xi.c, omega.arg, psi.arg, gamma.arg, A.arg, B.arg, a.arg, b.arg))
...
saem.alg <- function(n.rep = 500, n.mcmc = 20, n.alpha = 90) {
  ...
  for (k in 1:n.rep) {
    # MCMC
    mcmc.obj <- mcmc.alg(mcmc.rep[[k]], mcmc.obj, omega.c, psi.c, gamma.c, A.c, B.c, a.c, b.c)

    # E
    S1 <- mean((Y - f(mcmc.obj$xi.c, A.arg = A.c, B.arg = B.c, a.arg = a.c, b.arg = b.c))^2)
