...
Durant sa présentation, nous détaillerons les étapes MCMC [@MCMC] et SMC [@SMC] avant de présenter l'algorithme complet.
...
Afin de justifier l'intérêt de l'utilisation d'un algorithme MCMC ou SMC, nous nous sommes intéressés à l'identifiabilité du modèle sinusoïdal.
