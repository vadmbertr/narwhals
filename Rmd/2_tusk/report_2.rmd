...
Certains chercheurs danois, comme Eva Garde, s'intéressent plus particulièrement à l'estimation de la durée de vie des narvals via l’information contenue dans cette dent.
...
Visuellement, les reconstructions de $\hat{Y}$ sont très semblables et très satisfaisantes.
Celle de $\hat{\xi_x}$ proposée par l'algorithme SAEM-SMC est apparu légèrement meilleure que celle de SAEM-MCMC, les deux demeurant tout à fait fidèles à la réalisation originale du processus.
L'estimation des paramètres $\hat{\theta}$ a donné des résultats assez différents entre les deux approches.
