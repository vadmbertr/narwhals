...
De plus, nous avons choisi de rendre le paramètre $\delta$ adaptatif en fonction du taux d'acceptation pour chaque point au fil des itérations k. Cette mise en place rajoute donc une partie d'actualisation à l'algorithme précédent, ce qui donne finalement l'Algorithme \@ref(alg:MCMC) à M itérations. 
...
[Présentation de la methode de simulation ainsi que des résultats]

### MCMC & Filtre particulaire
