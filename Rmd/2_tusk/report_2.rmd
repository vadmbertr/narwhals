...
\end{itemize}
\item La puissance de $\alpha$ est de $0.8$, afin que la suite converge. En effet, si la puissance est trop élevè nottement avec $\alpha^2$, la suite diverge au fur et a mesure ne permettant pas une approximation.
...
Cependant, nous remarquons que les estimations des paramètres via la méthode SMC varient bien plus, et sont parfois très éloignées de la valeur réele. En effet, pour $\omega$ et $\gamma$ sont parfois sous estimer de manière excessive sur certaines simulations ainsi que $b$ variant autour de sa valeur.
