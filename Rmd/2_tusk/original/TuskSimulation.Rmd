...
\begin{eqnarray*}
\log L(Y,\xi,\theta)&=&\sum{i=1}^n\log p(Y_i|\xi_i) +\sum{i=1}^n\log p(\xi_{i}|\xi_{i-1}) +\log p(\xi_1)\\
&=& -\sum{i=1}^n \frac{(Y_i-f(x_i, \varphi))^2}{2\omega^2}-\frac{n}{2}\log(\omega^2)\\
&&- \sum{i=1}^n\frac{(\xi_i-\xi_{i-1}e^{-\beta\Delta})^2}{\frac{\sigma^2}{\beta}(1-e^{-2\beta\Delta})} - \frac{n}{2}\log(\frac{\sigma^2}{\beta}(1-e^{-2\beta\Delta})) 
\end{eqnarray*}
