...
### Variation des coefficients autorégressifs
...
```{r}
source("../R/1_monte_carlo_conf_int.R")
expo.coef <- t(readRDS("../data/glmer_buzz_ARDepth_expo_par/expo.coef.rds"))
expo.coef.confint <- t(apply(expo.coef, 1, percentile_conf_int))
```

```{r}
ggplot() +
  geom_histogram(data = data.frame(coef = expo.coef[1, ]), aes(x = coef), position = "identity") +
  geom_vline(xintercept = expo.coef.confint[1, 1], lty = 2) +
  geom_vline(xintercept = expo.coef.confint[1, 2], lty = 2) +
  ylab("Effectif") + xlab("Coefficient 1")
```

```{r}
ggplot() +
  geom_histogram(data = data.frame(coef = expo.coef[2, ]), aes(x = coef), position = "identity") +
  geom_vline(xintercept = expo.coef.confint[2, 1], lty = 2) +
  geom_vline(xintercept = expo.coef.confint[2, 2], lty = 2) +
  ylab("Effectif") + xlab("Coefficient 2")
```

```{r}
ggplot() +
  geom_histogram(data = data.frame(coef = expo.coef[3, ]), aes(x = coef), position = "identity") +
  geom_vline(xintercept = expo.coef.confint[3, 1], lty = 2) +
  geom_vline(xintercept = expo.coef.confint[3, 2], lty = 2) +
  ylab("Effectif") + xlab("Coefficient 3")
```

```{r}
ggplot() +
  geom_histogram(data = data.frame(coef = expo.coef[4, ]), aes(x = coef), position = "identity") +
  geom_vline(xintercept = expo.coef.confint[4, 1], lty = 2) +
  geom_vline(xintercept = expo.coef.confint[4, 2], lty = 2) +
  ylab("Effectif") + xlab("Coefficient 4")
```
