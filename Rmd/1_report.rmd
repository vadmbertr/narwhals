...
Nous utilisons une régression bi-exponentielle afin de réduire le nombre de variables de `r maxlag.opt` à 4. \newline
...
```{r plot-AR-BiExp, fig.cap = "Régréssion bi-exponentielle des coefficients auto-régréssifs"}
...
Les coefficients obtenus suite à la régréssion bi-exponentielle sont présentés dans la table \@ref(tab:tab-AR-BiExp).
...
```{r tab-AR-BiExp}
kable(ARcoef.RegBiExp, caption = "Coefficients obtenus par régréssion bi-exponentielle",
      label="tab-AR-BiExp") %>%
