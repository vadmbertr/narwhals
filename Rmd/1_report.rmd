...
$$
Nous avons tout de suite restreint l'intervalle de recherche initial à $[30, 90]$.

Malheureusement le temps d'ajustement des modèles mixtes s'est avéré trop long (environ 1h30) pour nous permettre de mener à bien cette approche.
...
L'exposition aux perturbations est représentée par $1/dist$ où $dist$ est la distance en kilomètres séparant l'animal du bateau dont émane la perturbation.
