...
Le temps d'ajustement des modèles mixtes (environ 1h30) ne nous a pas permis d'obtenir de résultats définitifs pour le moment, la tâche tourne encore sur le cluster du Gricad. \newline
La figure \@ref(fig:plot-glmer-bic) présente les résultats temporaires. La courbe semble pour le moment similaire à celle obtenue sans l'ajout d'effets aléatoires.
...
Ci-dessous, plusieurs graphiques utiles pour valider visuellement le modèle. Nous n'avons pas eu trop le temps de les discuter, mais ils semblent encourageants. Nous avons tout de même remarqué une valeur franchement aberrante.
...
```{r, fig.cap = "Résidue selon le précédent. Avec la valeur aberrante"}
