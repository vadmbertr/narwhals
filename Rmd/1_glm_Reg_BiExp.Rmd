...
```{r,echo=F,warning=F,fig.cap="Régréssion bi-exponentielle des coefficients auto-régréssifs"}
...
Les coefficients obtenus suite à la régréssion bi-exponentielle sont présentés dans la table suivante :
